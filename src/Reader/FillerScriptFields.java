...
public class FillerScriptFields implements Filler{
    ...
    public LabWork creationsLabwork() {
        LabWork lab = new LabWork(CreationLabwork.getId(), readName(), readCoordinates(), LocalDateTime.now(), readMinimalPoint(), readDifficulty(), readPerson());
    ...
    public LabWork updateLabwork(int id) {
        LabWork lab = new LabWork(id, readName(), readCoordinates(), LocalDateTime.now(), readMinimalPoint(), readDifficulty(), readPerson());
        if (switcher & labSwitcher) {
            return lab;
        } else {
            return null;
